<?php
  ...
  */
  ...
  // category__and: 1=  Uncategorized, 4 = 存入股本, 3 =  往來記錄
  $posts = query_posts( array( 'author'=> $user_id, 'post_type' => 'post', 'category__and'=> 3, 'posts_per_page' => 6, 'post_status' => array('publish', 'pending', 'draft', 'auto-draft', 'future', 'private', 'inherit'), 'paged' => ( get_query_var('paged') ? get_query_var('paged') : 1 ) ) );
